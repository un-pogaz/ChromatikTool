...
namespace Chromatik.Xml
{
    ...
    /// </summary>
    public class ElementColectionException : ChromatikXMLtoolException
    {
        /// <summary>
        /// Initialise une nouvelle instance de la classe ParentColectionException
        /// </summary>
        public ElementColectionException() : base() { }
        ...
        public ElementColectionException(string message) : base(message) { }
        ...
        public ElementColectionException(string message, Exception innerException) : base(message, innerException) { }
        ...
        protected ElementColectionException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
}
