...
namespace System.Csv
{
    ...
    public static class CsvReader
    {
        ...
        /// <param name="options">The optional options to use when reading.</param>
        public static IEnumerable<ICsvLine> ReadFromFile(string path, CsvOptions options = null)
        {
            if (path == null)
                throw new ArgumentNullException(nameof(path));

            return ReadFromTextImpl(File.ReadAllText(path), options);
        }
        ...
        private static IEnumerable<ICsvLine> ReadFromFileImpl(string path, CsvOptions options)
        {
